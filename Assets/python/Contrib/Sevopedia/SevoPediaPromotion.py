...
##--------	BUGFfH: Added by Denev 2009/08/12 (from CvPediaPromotion.py by Kael)
	...
	def isMagicSpherePromotion(self, pPromotion):
		...
		lChannelingPromotions = [gc.getInfoTypeForString('PROMOTION_CHANNELING1'),gc.getInfoTypeForString('PROMOTION_CHANNELING2'), gc.getInfoTypeForString('PROMOTION_CHANNELING3'), gc.getInfoTypeForString('PROMOTION_CHANNELING4')]
