		...
		for act in actions :
			...
			if sActTag == "gameStart" :
				...
				if self.iActivePlayer == iPlayerAction :
					sDrawCard = localText.getText("TXT_KEY_SOMNIUM_DRAW", ())
					...
					if self.gameMP :
						...
						szText += self.colorLight + u". " + u"</color>"
						sEndTurn = localText.getText("TXT_KEY_SOMNIUM_END_TURN", ())
				...
				lArgs = []
				if iCardType > 9 :
					lArgs.append(localText.getText("TXT_KEY_SOMNIUM_TYPE_%d" %iCardType, ()))
					if self.iActivePlayer == iPlayerAction :
				...
				iPlayerAction = act[1]
				sDeath = localText.getText("TXT_KEY_SOMNIUM_TYPE_11", ())
				if self.iActivePlayer == iPlayerAction :
				...
				sJoker = localText.getText("TXT_KEY_SOMNIUM_TYPE_10", ())
				sCardType = localText.getText("TXT_KEY_SOMNIUM_TYPE_%d" %iCardType, ())
