...
#Magister Start
			...
			screen.addPullDownString("WBSelectClass", CyTranslator().getText("TXT_KEY_TIER_#", (5,)), -13, -13, -13 == self.iSelectClass)
			screen.addPullDownString("WBSelectClass", CyTranslator().getText("TXT_KEY_TIER_#", (6,)), -14, -14, -14 == self.iSelectClass)
			screen.addPullDownString("WBSelectClass", CyTranslator().getText("TXT_KEY_TIER_#", (7,)), -15, -15, -15 == self.iSelectClass)
			screen.addPullDownString("WBSelectClass", CyTranslator().getText("TXT_KEY_TIER_#", (8,)), -16, -16, -16 == self.iSelectClass)
			...
			for i in xrange(gc.getNumUnitInfos()):
				...
				if self.iSelectClass == -2:
					...
					if ItemInfo.getTier() == 4:
						lItems.append([sDesc, i])
				elif self.iSelectClass == -13:
					if ItemInfo.getTier() == 5:
						lItems.append([sDesc, i])
				elif self.iSelectClass == -14:
					if ItemInfo.getTier() == 6:
						lItems.append([sDesc, i])
				elif self.iSelectClass == -15:
					if ItemInfo.getTier() == 7:
						lItems.append([sDesc, i])
				elif self.iSelectClass == -16:
					if ItemInfo.getTier() == 8:
						lItems.append([sDesc, i])
				else:
