...
#Magister Stop
	...
	def placePlotType(self):
		...
		if pPlot.getPlotType() == PlotTypes.PLOT_LAND:
			sColor = CyTranslator().getText("[COLOR_POSITIVE_TEXT]", ())
			sHeader = CyTranslator().getText("TXT_KEY_PLOT_FLATLANDS", ())
			# sHeader = TerrainInfo.getDescription() CyTranslator().getText("TXT_KEY_PLOT_FLATLANDS", ())
		# sText = "<font=3>" + sColor + TerrainInfo.getDescription() + "</font></color>"
		sText = "<font=3>" + sColor + CyTranslator().getText("TXT_KEY_PLOT_FLATLANDS", ()) + "</font></color>"
