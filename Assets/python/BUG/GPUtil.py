...
g_gpBarList = (
				...
				"UNIT_SCIENTIST",
				"UNIT_SHADE",
				"UNIT_DISCIPLE_OF_ACHERON",
				"UNIT_PRIEST_FOXMEN",
				"UNIT_LUONNOTAR",
				"UNIT_HIGH_PRIEST_GREY"
				)
...
def init():
	...
	g_gpColors[GP_GREAT_GENERAL] = gc.getInfoTypeForString("COLOR_GREEN")
	...
	g_gpColors[GP_SHADE] = gc.getInfoTypeForString("COLOR_LIGHT_GREY")
	g_gpColors[GP_DISCIPLE_OF_ACHERON] = gc.getInfoTypeForString("COLOR_PLAYER_DARK_ORANGE")
	g_gpColors[GP_PRIEST_FOXMEN] = gc.getInfoTypeForString("COLOR_CYAN")
	g_gpColors[GP_LUONNOTAR] = gc.getInfoTypeForString("COLOR_WHITE")
	g_gpColors[GP_HIGH_PRIEST_GREY] = gc.getInfoTypeForString("COLOR_GREY")
		
	global g_unitIcons
	g_unitIcons = {}

	g_unitIcons[g_gpUnitTypes[GP_ADVENTURER]] = u"%c" %(CyGame().getSymbolID(FontSymbols.MOVES_CHAR))
	g_unitIcons[g_gpUnitTypes[GP_ARTIST]] = u"%c" %(gc.getCommerceInfo(CommerceTypes.COMMERCE_CULTURE).getChar())
	g_unitIcons[g_gpUnitTypes[GP_GREAT_GENERAL]] = u"%c" %(CyGame().getSymbolID(FontSymbols.GREAT_GENERAL_CHAR))
	...
	g_unitIcons[g_gpUnitTypes[GP_SHADE]] = u"%c" % (gc.getReligionInfo(gc.getInfoTypeForString('RELIGION_ETERNAL_CABAL')).getChar())
	g_unitIcons[g_gpUnitTypes[GP_DISCIPLE_OF_ACHERON]] = u"%c" % (gc.getReligionInfo(gc.getInfoTypeForString('RELIGION_CULT_OF_THE_DRAGON')).getChar())
	g_unitIcons[g_gpUnitTypes[GP_PRIEST_FOXMEN]] = u"%c" % (gc.getReligionInfo(gc.getInfoTypeForString('RELIGION_FOXMEN')).getChar())
	g_unitIcons[g_gpUnitTypes[GP_LUONNOTAR]] = u"%c" % (gc.getReligionInfo(gc.getInfoTypeForString('RELIGION_CHILDREN_OF_THE_ONE')).getChar())
	g_unitIcons[g_gpUnitTypes[GP_HIGH_PRIEST_GREY]] = u"%c" % (gc.getReligionInfo(gc.getInfoTypeForString('RELIGION_GREY_COUNCIL')).getChar())
