...
##		self.itFeatureReefs = GetInfoType("FEATURE_REEFS")
		self.itNoFeature = -1
		self.itFeatureIce = -1
		self.itFeatureKelp = -1
		self.itFeatureReefs = -1
...
##		self.itImprovementCityRuinsAncient = GetInfoType("IMPROVEMENT_CITY_RUINS_ANCIENT")
		self.itNoImprovement = -1
		self.itImprovementCityRuinsAncient = -1
...
def getCustomMapOptionDescAt(argsList):
	...
	if optionID == 0: #Cohesion
		...
		if selectionID == 0:
			return "Off"
		if selectionID == 1:
			return "On (place Ancient Forests)"
